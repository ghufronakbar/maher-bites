...
export default async function DashboardProductDetailPage({
  ...
  return (
    <div className="space-y-8">
        ...
        <div>
          ...
          {status === "error" ? (
            <p className="mt-4 inline-flex rounded-full bg-red-50 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-red-600">
              Gagal menyimpan produk. Periksa data Anda.
            </p>
          ) : null}
        </div>
        <Link
      ...
      <form action={upsertProductAction} className="space-y-8">
        <input
          type="hidden"
          name="redirectTo"
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <label className="flex flex-col text-sm font-medium text-zinc-700">
            ...
            <input
              name="ingredients"
              defaultValue={(initialProduct.ingredients ?? []).join(", ")}
              className="mt-1 rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
            />
          </label>
          <label className="flex flex-col text-sm font-medium text-zinc-700">
            ...
            <input
              name="allergens"
              defaultValue={(initialProduct.allergens ?? []).join(", ")}
              className="mt-1 rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
            />
          </label>
        ...
        <section className="space-y-4">
          ...
          <ImageFields name="images" initialImages={initialProduct.images} />
        </section>
        <section className="space-y-4">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wide text-zinc-500">
