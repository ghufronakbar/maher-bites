        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-amber-400 font-semibold text-zinc-900">
                MB
              </span>
          ...
          <div className="hidden md:block">
            <a
              href={`${site.whatsapp}?text=${encodeURIComponent('Halo Maher Bites, saya ingin pesan camilan.')}`}
